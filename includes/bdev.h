...
extern uint16_t** LwVM_chunks;
extern uint32_t LwVM_numValidChunks;
extern uint32_t LwVM_rangeShiftValue;
extern uint32_t LwVM_rangeByteCount;
extern uint64_t LwVM_seek;
